...
TRANSFORMERS_VERSION="4.51.3"
# accelerate: no specific patch version required by VibeVoice or transformers 4.51.3.
# Minimum floor is 1.6.0 (proven working). Install latest compatible release.
...
# ── Step 3 — Pinned transformers + other deps ─────────────────────────────────
log ""
log "[3/9] Installing pinned transformers==${TRANSFORMERS_VERSION}, accelerate>=${ACCELERATE_MIN}..."
pip install \
    "transformers==${TRANSFORMERS_VERSION}" \
